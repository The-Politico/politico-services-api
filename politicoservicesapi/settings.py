...
STATIC_ROOT = os.path.join(BASE_DIR, "politicoservicesapi", "staticfiles")
...
if DEBUG:
    ...
    CORS_ORIGIN_WHITELIST = ("the-politico.github.io", "datalab.politico.com")
    CORS_ORIGIN_REGEX_WHITELIST = (r"localhost:[0-9]{4}",)
